...
from legged_gym.envs.adam1_servo.adam1_servo_config import Adam1ServoRoughCfg, Adam1ServoRoughCfgPPO
from legged_gym.envs.adam1_servo.adam1_servo_env import Adam1ServoRobot
...
task_registry.register( "adam1_servo", Adam1ServoRobot, Adam1ServoRoughCfg(), Adam1ServoRoughCfgPPO())
